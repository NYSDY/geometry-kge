...
class Train(nn.Module):
    ...
    def doTrain(self):
        ...
        for epoch in range(nepoch):
            ...
            if epoch == 0:
                ...
                with open("../vector/" + self.args.dataset+"/concept2vec" + str(epoch + 1) + ".vec", 'w') as file:
    ...
    def doTrainInstanceOf(self, ids):
        ...
        dis = F.relu(norm(torch.div(entity_embs - concept_embs, radius_axis), pnorm=2) - torch.square(radius))
