...
from transflex import Dataset, load_processed, Train
...
def main(bern, margin_ins, margin_sub , pnorm):
    ...
    for epoch in [1000, 1500, 2000]:
        ...
        instance_out_dict, subclass_out_dict, m_instance_out_dict, m_subclass_out_dict,delta_ins, delta_sub,  m_delta_ins, m_delta_sub = test_isA(args.dataset, epoch)
...
if __name__ == '__main__':
    bern_list = [0, 1]
    margin_list = [0.1, 0.3, 0.4, 0.5, 1, 2]
    pnorm_list = [1, 2]
    ...
    main(bern=0, margin_ins=0.3, margin_sub=0.1, pnorm=2)